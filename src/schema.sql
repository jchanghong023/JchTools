...
CREATE INDEX IF NOT EXISTS idx_files_name ON files(name,size,id);
...
CREATE TABLE IF NOT EXISTS archive_members (
 id INTEGER PRIMARY KEY, path TEXT NOT NULL, size INTEGER NOT NULL, directory INTEGER NOT NULL
);
