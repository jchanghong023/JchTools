...
CREATE TABLE IF NOT EXISTS files (
 ...
 size INTEGER NOT NULL CHECK(size>=0), mtime INTEGER NOT NULL, created INTEGER,
 name16 INTEGER NOT NULL, rel16 INTEGER NOT NULL,
 identity TEXT NOT NULL, links INTEGER NOT NULL, prehash TEXT, hash TEXT,
 active INTEGER NOT NULL DEFAULT 1, cleanable INTEGER NOT NULL DEFAULT 0
);
